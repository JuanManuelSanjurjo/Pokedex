...
function Sidebar({setSidebar}) {
  ...
  return (
    <div className='sidebar' id='sidebar' onClick={closeSidbar}>
          ...
          <a className='sideBarLink' href='https://www.pokemon.com/es' target='_blank' rel='noreferrer'>Official Site <img className="pokeballImgSmall" src='./pokeball.png'></img></a>
          <a className='sideBarLink' href='https://pokeapi.co/' target='_blank' rel='noreferrer'>Link a algo <img className="pokeballImgSmall" src='./pokeball.png'></img></a>
          <a className='sideBarLink' href='https://pokeapi.co/' target='_blank' rel='noreferrer'>Link a algo <img className="pokeballImgSmall" src='./pokeball.png'></img></a>
